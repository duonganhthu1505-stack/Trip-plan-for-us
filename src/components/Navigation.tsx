      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18 gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
            <PWAInstallButton />
            {!isConnectedToCloud ? (
              <button id="nav-connect-cloud-btn" type="button" onClick={onConnectGoogle} className="hidden sm:flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-[#FFF3CD] hover:bg-[#FFEBAA] active:scale-[0.98] border border-[#F6D88A] text-[#856404] text-xs font-semibold shadow-2xs transition-all cursor-pointer animate-pulse" title="Nhấn để kết nối Google & đồng bộ dữ liệu sang điện thoại ngay!">
                <Cloud className="w-3.5 h-3.5 text-[#D97706]" /><span className="text-[11px] font-semibold">Đồng bộ sang ĐT</span>
              </button>
            ) : (
