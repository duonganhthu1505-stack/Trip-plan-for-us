          ...
          <div className="flex items-center justify-between h-16 sm:h-18 gap-2">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
              ...
              <button
                ...
                className="hidden sm:flex p-2 rounded-xl border bg-[#FAF7F2] border-[#E8DEC8] text-[#6E4F36] cursor-pointer"
          ...
          <div id="nav-mobile-menu" className="md:hidden bg-[#FFFDF9] border-t border-[#E8DEC8] px-4 py-3.5 space-y-3 shadow-xl max-h-[calc(100vh-4.5rem)] overflow-y-auto">
            <div className="grid grid-cols-1 gap-1.5">
              ...
              <button
                ...
                type="button"
                onClick={openSettings}
                className="w-full flex items-center gap-3 px-3.5 py-2.5 rounded-xl text-sm font-medium cursor-pointer touch-manipulation text-[#5C4033] bg-[#FAF7F2]/80 border border-[#EFE6DB]"
              >
                <SettingsIcon className="w-4 h-4" />
                <span>{t.tabs.settings}</span>
              </button>
